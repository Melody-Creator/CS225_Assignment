...
int main()
{
    ...
    do
    {
        ...
        switch(op)
        {
            ...
            case 12:{
                if(type == 0)  mylist1.insertionSort();
                else  mylist2.insertionSort();
                break;
            }
            default: return(0);
        }
    ...
    /*
    test cases:
    input1: 8 13 5 1 2 4 3 7 6  //an ordinary case
    output1: 1 2 3 4 5 6 7 8 13
    input2: 6 5 4 3 2 1 1        //with repeated elements
    output2: 1 1 2 3 4 5 6
    input3: 1.2 -1.3 5.9 4.5    //double-type elements
    output3: -1.3 1.2 4.5 5.9
    */
}
